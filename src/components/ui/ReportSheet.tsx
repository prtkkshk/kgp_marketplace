...
const REPORT_REASONS: { value: ReportReason; label: string }[] = [
 { value: 'prohibited', label: 'Prohibited item (alcohol/drugs/weapons/academic bg/sublet)' },
...
export const ReportSheet: React.FC<ReportSheetProps> = ({
 ...
 <div className="flex items-center gap-2 p-3 bg-danger-wash border border-danger/20 rounded-xl text-xs font-medium text-danger">
 <Flag className="w-4 h-4 shrink-0" />
 <span>Reporting: "{title}"</span>
 </div>

 {error && (
 <div className="p-3 bg-danger-wash border border-danger/20 text-danger text-xs rounded-xl flex items-center gap-2">
