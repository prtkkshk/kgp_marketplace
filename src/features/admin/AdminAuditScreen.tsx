...
export const AdminAuditScreen: React.FC = () => {
 ...
 <p className="text-xs text-subtle">Immutable system audit log of all moderator and admin actions</p>
 </div>
 <div className="flex items-center gap-1.5 px-3 py-1.5 bg-surface-2 border border-line rounded-xl text-[11px] font-bold text-ink">
 ...
 <FileText className="w-10 h-10 text-subtle mx-auto mb-2 opacity-50" />
 ...
 <td className="p-3 text-subtle max-w-xs truncate">{log.reason || '—'}</td>
 </tr>
 ))}
 </tbody>
 </table>
