...
const RLS_READY = Boolean(process.env.SUPABASE_URL && process.env.SUPABASE_SERVICE_ROLE_KEY);
...
(RLS_READY ? describe : describe.skip)('SEC-05 regression tests', () => {
...
(RLS_READY ? describe : describe.skip)('SEC-07 regression tests', () => {
